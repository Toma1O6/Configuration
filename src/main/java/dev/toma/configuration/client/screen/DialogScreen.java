...
public class DialogScreen extends Screen {
    ...
    public static final Component TEXT_CONFIRM = new TranslatableComponent("text.configuration.screen.dialog.confirm");
    public static final Component TEXT_CANCEL = new TranslatableComponent("text.configuration.screen.dialog.cancel");
