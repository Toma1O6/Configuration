...
public final class ColorWidget extends Widget {
    ...
    private static final class ColorSelectorDialog extends DialogScreen {
        ...
        protected void init() {
            ...
            this.addButton(new ColorDisplay(dialogLeft + 5 + dialogWidth - rightMargin + 5, dialogTop + 20, rightMargin - 15, rightMargin - 15, argb, this::getResultColor));
        ...
        private static final class ColorDisplay extends Widget {
        ...
        private static final class ColorSlider extends AbstractSlider {

            private final ColorComponent colorComponent;

            public ColorSlider(int x, int y, int width, int height, int color, ColorComponent colorComponent) {
                super(x, y, width, height, StringTextComponent.EMPTY, (colorComponent.getByteColor(color) / 255.0D));
            ...
            protected void updateMessage() {
                ITextComponent colorLabel = this.colorComponent.updateTitle(this.value);
        ...
        private enum ColorComponent {
            ...
            ColorComponent(int bitOffset) {
                ...
                this.title = val -> {
                    ...
                    return new TranslationTextComponent(translate, colorValue);
                };
            }
