...
public class ConfigGui extends GuiScreen {
    ...
    private ConfigGuiModList modList;
    ...
    public ConfigGui(GuiScreen mainMenu) {
    ...
    public void initGui() {
        ...
        this.modList = new ConfigGuiModList(this, mods, listWidth, slotHeight);

        this.buttonList.add(new GuiButton(6, ((modList.getRight() + this.width) / 2) - 100, this.height - 38, I18n.format("gui.done")));
        ...
        search = new GuiTextField(0, getFontRenderer(), 12, modList.getBottom() + 17, modList.getListWidth() - 4, 14);
    ...
    public void updateScreen() {
        ...
        if (!sorted) {
            ...
            selected = modList.setAndGetSelectedIndex(mods.indexOf(selectedMod));
            sorted = true;
        }
    }
        ...
        if (button.enabled) {
            ...
            if (type != null) {
                ...
                switch (button.id) {
                    ...
                    case 20: {
                        try {
                            Optional<ConfigPlugin> optional = Configuration.getPlugin(selectedMod.getModId());
                            if(optional.isPresent()) {
                                ConfigPlugin plugin = optional.get();
                                Configuration.getConfig(selectedMod.getModId()).ifPresent(cfg -> mc.displayGuiScreen(plugin.getClientHandles().createConfigScreen(this, cfg, plugin)));
                            } else {
    ...
    private class Info extends GuiScrollingList {
        ...
        public Info(int width, java.util.List<String> lines, @Nullable ResourceLocation logoPath, Dimension logoDims) {
            super(ConfigGui.this.getMinecraftInstance(),
                    width,
                    ConfigGui.this.height,
                    32, ConfigGui.this.height - 88 + 4,
                    ConfigGui.this.listWidth + 20, 60,
                    ConfigGui.this.width,
                    ConfigGui.this.height);
        ...
        private java.util.List<ITextComponent> resizeContent(java.util.List<String> lines) {
            ...
            for (String line : lines) {
                ...
                if (maxTextLength >= 0) {
                    ret.addAll(GuiUtilRenderComponents.splitText(chat, maxTextLength, ConfigGui.this.fontRenderer, false, true));
                }
            }
            return ret;
        }
        ...
        protected void drawHeader(int entryRight, int relativeY, Tessellator tess) {
            ...
            if (logoPath != null) {
                ...
                ConfigGui.this.mc.renderEngine.bindTexture(logoPath);
            ...
            for (ITextComponent line : lines) {
                if (line != null) {
                    GlStateManager.enableBlend();
                    ConfigGui.this.fontRenderer.drawStringWithShadow(line.getFormattedText(), this.left + 4, top, 0xFFFFFF);
            ...
            if (line != null) {
                ...
                for (ITextComponent part : line) {
                    if (!(part instanceof TextComponentString))
                        continue;
                    k += ConfigGui.this.fontRenderer.getStringWidth(((TextComponentString) part).getText());
                    if (k >= x) {
                        ConfigGui.this.handleComponentClick(part);
                        break;
                    }
                }
            }
